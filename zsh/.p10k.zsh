# Generated by Powerlevel10k configuration wizard on 2025-11-01 at 16:47 SAST.
...
# Add padding (extra newlines) below the prompt
function p10k-on-post-prompt() {
  # 1 newline for subtle spacing, 2 for a bigger block
  print -n '\n'
}
