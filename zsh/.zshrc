...
plugins=(git zsh-syntax-highlighting zsh-auto-suggestions)
...
source /Users/deankopping/Desktop/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
eval "$(rbenv init -)"
eval "$(rbenv init -)"
...
cm() {
  ...
  if [ -z "$rest" ]; then
    # If only one word, just add colon after it
